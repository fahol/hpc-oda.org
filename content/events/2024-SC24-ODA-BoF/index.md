...
summary: SC24 Birds of a Feather on Operational Data Analytics. Focus on AI and the evolution of ODA over time, featuring Woong Shin on OLCF's data journey across two generations of HPC systems.
abstract: |-
  ...
  The 2024 session centered on AI and the evolution of ODA over time. Woong
  Shin (Oak Ridge National Laboratory) presented on the data journey of OLCF
  across two generations of HPC systems, sharing lessons learned from
  operating, observing, and analyzing production systems at scale. The BoF
  brought together HPC operations practitioners to share ODA use cases,
  discuss open problems, and provide feedback through interactive discussion.
